...
int dsi_panel_enable(struct dsi_panel *panel)
{
	...
	if (!strcmp(panel->name, "Dual dsi csot nt36532 video mode panel with DSC")
		...
		switch (panel->cur_mode->timing.refresh_rate) {
			case 30:
				rc = dsi_panel_tx_cmd_set(panel, DSI_CMD_SET_FPS_SWITCH_30);
				break;
			case 48:
				rc = dsi_panel_tx_cmd_set(panel, DSI_CMD_SET_FPS_SWITCH_48);
				break;
			case 50:
				rc = dsi_panel_tx_cmd_set(panel, DSI_CMD_SET_FPS_SWITCH_50);
				break;
			case 60:
				rc = dsi_panel_tx_cmd_set(panel, DSI_CMD_SET_FPS_SWITCH_60);
				break;
			case 90:
				rc = dsi_panel_tx_cmd_set(panel, DSI_CMD_SET_FPS_SWITCH_90);
				break;
			case 120:
				rc = dsi_panel_tx_cmd_set(panel, DSI_CMD_SET_FPS_SWITCH_120);
				break;
			case 144:
				rc = dsi_panel_tx_cmd_set(panel, DSI_CMD_SET_FPS_SWITCH_144);
				break;
			default:
